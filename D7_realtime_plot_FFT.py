...
class DataInlet(Inlet):  
    def __init__(self,info:pylsl.StreamInfo,plt:pg.PlotItem,fftplt:pg.PlotItem):
...
def main():
    ...
    # info = pylsl.StreamInfo('openvibe', 'EEG', 1, 250, 'float32')
    inlets: List[Inlet] = []
    ...
    for ch in range(channel_count):
        ...
        if info.type() =="EEG":
            ...
            inlets.append(DataInlet(info, mch[ch],fftch[ch]))
